...
class ProductModel extends Model
{
    ...
    {
        $group = DB::query("SELECT CONCAT('group_id=', g.group_id, 'group_name=', g.name) AS 'group'
        ...
        $options = DB::query("SELECT 
                                        GROUP_CONCAT(
                                            CONCAT(
                                                ...
                                                '|option_name=', ovd.name,
                                                '|option_image=', ov.image,
                                                '|option_sku=', pov.sku, 
                                                '|option_price=', pov.price, 
                                                '|option_base_price=', pov.base_price
                                                )
